...
<div id="content">
  <div class="bg-success px-3"><?php echo '<p class="text-white"><strong>' . $message . '</strong></p>'; ?></div>
  ...
  <div class="page show">
    <div class="attributes">
      ...
      <p><strong>Created at  <?php echo date('H:i:s d-m-Y', h($ad->created_at)) . ' by ' . h($ad->author); ?>
      </strong></p>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-danger">
            <a style="text-decoration: none; color: white" href="<?php echo 'delId.php?id=' . h(u($ad->id)); ?>">
            Delete ad</a>
          </button>
        </div>
      </div>
