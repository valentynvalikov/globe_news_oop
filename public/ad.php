...
<h1 class="mb-4"><?php echo h($ad->title); ?></h1>
<p><strong><?php echo h($ad->description); ?></strong></p>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">You are about to delete an ad! Are you sure?!</div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="button" class="btn btn-danger">
                    <a style="text-decoration: none; color: white" href="<?php echo 'delId.php?id=' . h(u($_GET['id'])); ?>">Delete ad</a>
                </button>
            </div>
        </div>
    </div>
